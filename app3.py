# -*- coding: utf-8 -*-
"""
Created on Thu Oct 16 15:59:37 2025
...
# ==============================================================
# 📂 1️⃣ Data inladen (één keer via caching)
# ==============================================================
...
# ==============================================================
# 📊 3️⃣ Voorbereiding van data per jaar (gecached)
# ==============================================================
...
# Keuze voor visualisatietype
visualisatie = st.radio(
    "Kies visualisatietype:",
    ["MarkerCluster (met popups)", "FastMarkerCluster (sneller, zonder popups)"]
)
...
if visualisatie == "MarkerCluster (met popups)":
    cluster = MarkerCluster(name="Meetpunten").add_to(m)

    # Maximaal aantal markers beperken voor performance
    ...
    # --- FastMarkerCluster: razendsnel, maar zonder popups ---
    punten = df_jaar[["lat", "lon"]].dropna().values.tolist()
    FastMarkerCluster(punten).add_to(m)
